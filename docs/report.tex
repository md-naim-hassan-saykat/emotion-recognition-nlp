...
BERT was fine-tuned for 5 epochs using the AdamW optimizer with a learning rate of $2 \times 10^{-5}$. Classical models use scikit-learn defaults (SVM with a linear kernel, RF with 100 estimators, LR with regularization as in \texttt{liblinear}). All results are measured on the held-out test split.
